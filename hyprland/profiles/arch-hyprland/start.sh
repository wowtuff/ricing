...
src_dir=/workspace/profiles/arch-hyprland/runtime
mkdir -p "$rice_dir"
...
if [ -d "$src_dir" ]; then
    ...
    link_path "$src_dir/scripts" "$cfg_dir/hypr/scripts"
    link_path "$src_dir/startpage" "$cfg_dir/hypr/startpage"
    link_path "$src_dir/wallpapers" "$cfg_dir/hypr/wallpapers"
fi
